...
public final class TestUtilsBugemons {
    ...
    public static Bugemon createDefaultBugemon(String id) {
        ...
        Effect effect = new Effect(ulb.models.bugemon.Type.FLORA, "TestEffect", "Flora", 10,
                "1 turn");
        Attack attack1 = new Attack("TestAttack1", "TestAttack1", Type.FLORA, "", 30, effect);
        Attack attack2 = new Attack("TestAttack2", "TestAttack2", Type.FLORA, "", 20, effect);
