 ...
 *
 * <p>
 * {@code CombatVictoryController} is displayed by the {@link MetaController}
 * whenever the player's {@link ulb.models.bugemon_team.BugemonTeam} defeats the
 * opponent's team during a combat session. It presents the player with a
 * continue option:
 * <ul>
 *   <li>{@link #cont()} — resets the team and navigates back to the main menu
...
public class CombatVictoryController extends Controller<CombatVictoryView> {
    ...
    public CombatVictoryController(MetaController metaController) throws IOException {
        ...
        this.view.setOnContinue(this::cont);
    }
     ...
     *
     * <p>
     * <em>Note:</em> if a Bugemon levelled up during the completed combat, a
     * future implementation should navigate to a dedicated level-up screen before
     * returning to the main menu. This behaviour is not yet implemented.
     * </p>
     *
     * <p>
