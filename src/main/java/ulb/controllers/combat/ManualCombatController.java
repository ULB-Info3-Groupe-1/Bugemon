 ...
 * @see ManualTrainer
 * @see AutoTrainer
 * @see ManualCombatFXController
 */
public class ManualCombatController extends CombatController {
     ...
     * {@link ManualCombatFXController}, and registers this controller as the view's
     * event handler.
     *
     * <p>
     ...
     *                       {@code null}.
     * @throws IOException if the {@link ManualCombatFXController} fails to load its FXML
     *                     resource.
     */
     public ManualCombatController(MetaController metaController, PlayerService playerService, LevelUpService levelUpService) {
