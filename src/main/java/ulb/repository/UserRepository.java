...
public class UserRepository {
    ...
    /**
     * Create a new user in the database with the specified username. This method executes an SQL statement to insert a
     * new user record into the database and retrieves the generated user ID for the newly created user.
     *
     * @param username
    ...
    /**
     * Retrieve the user ID associated with the specified username from the database. This method executes an SQL query
     * to search for a user record with the given username and returns the corresponding user ID if found. If no user is
     * found with the specified username, an empty Optional is returned.
     *
     * @param username
     *            the username for which to retrieve the user ID. This should correspond to a user that has been
     *            previously created in the database.
     * @return an Optional containing the user ID associated with the specified username if found, or an empty Optional
     *         if no user is found with that username. If an error occurs during the database query, an
    ...
    /**
     * Save a UserBugemon to the database. This method takes a UserBugemonDTO object containing the details of the
     * UserBugemon to be saved and executes an SQL statement to insert a new record into the database representing this
     * UserBugemon. The details of the UserBugemon, such as its current stats and level, are included in the DTO and are
     * used to populate the corresponding fields in the database record.
     *
     * @param dto
     *            the UserBugemonDTO object containing the details of the UserBugemon to be saved to the database. This
     *            DTO should include the user ID, Bugemon ID, and the current stats and level of the UserBugemon. The
     *            method will use this information to create a new record in the database representing this UserBugemon.
     *            If an error occurs during the database operation, an IllegalStateException is thrown.
     */
    ...
    /**
     * Update an existing UserBugemon in the database. This method takes a UserBugemonDTO object containing the updated
     * details of the UserBugemon and executes an SQL statement to update the corresponding record in the database. The
     * method identifies the UserBugemon to be updated based on the user ID and Bugemon ID provided in the DTO, and
     * updates the current stats and level of the UserBugemon in the database with the new values from the DTO. If an
     * error occurs during the database operation, an IllegalStateException is thrown.
     *
     * @param dto
     *            the UserBugemonDTO object containing the updated details of the UserBugemon to be updated in the
     *            database. This DTO should include the user ID, Bugemon ID, and the new current stats and level of the
     *            UserBugemon. The method will use this information to identify the existing record in the database
     *            representing this UserBugemon and update it with the new values. If an error occurs during the
    ...
    /**
     * Retrieve a list of UserBugemonDTO objects representing the UserBugemons owned by a specific user from the
     * database. This method executes an SQL query to search for all UserBugemon records associated with the given user
     * ID and constructs a list of UserBugemonDTO objects containing the details of each UserBugemon found. The details
     * include the Bugemon ID, current stats, and level of each UserBugemon. If an error occurs during the database
     * query, an IllegalStateException is thrown.
     *
     * @param userId
     *            the ID of the user for whom to retrieve Bugemons
     * @return a list of UserBugemonDTO objects representing the UserBugemons owned by the specified user
     */
    ...
    /**
     * Create a new team for a user in the database. This method takes the user ID and the name of the team to be
     * created, and executes an SQL statement to insert a new team record into the database associated with the
     * specified user. The team name is provided as a parameter, and the method ensures that the new team is linked to
     * the correct user in the database. If an error occurs during the database operation, an IllegalStateException is
     * thrown.
     *
     * @param userId
    ...
    /**
     * Delete an existing team for a user from the database. This method takes the user ID and the name of the team to
     * be deleted, and executes an SQL statement to remove the corresponding team record from the database. The method
     * identifies the team to be deleted based on the provided user ID and team name, ensuring that only the specified
     * team associated with the correct user is removed from the database. If an error occurs during the database
     * operation, an IllegalStateException is thrown.
     *
     * @param userId
    ...
    /**
     * Retrieve a list of TeamDTO objects representing the teams owned by a specific user from the database. This method
     * executes an SQL query to search for all team records associated with the given user ID and constructs a list of
     * TeamDTO objects containing the details of each team found. The details include the user ID and the name of each
     * team. If an error occurs during the database query, an IllegalStateException is thrown.
     *
     * @param userId
