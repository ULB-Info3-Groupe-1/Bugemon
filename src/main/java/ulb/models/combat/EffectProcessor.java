...
public class EffectProcessor {
    ...
    public List<TurnStep> applyEffects(
            Attack attack, CombatBugemon attacker, CombatBugemon defender, CombatTeam attackerTeam) {
    ...
    private List<TurnStep> applySingleEffect(
            Effect effect,
