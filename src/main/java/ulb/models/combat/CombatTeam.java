...
public class CombatTeam {
    ...
    /**
     * Persists all Bugemon HP values back to their underlying {@link ulb.models.run.RunBugemon} instances, making the
     ...
     *
     * @return a {@link ulb.models.combat.snapshot.TeamSnapshot} reflecting the current state
     */
