...
/**
 * Represents the state of a combat from the perspective of the AI, used for
 * MiniMax simulations. It includes the teams,
...
final class CombatState {
    ...
    /**
     * Factory method to create a CombatState from the current state of the
     * trainers.
     *
     * @param aiTrainer
     ...
     * @return a CombatState representing the current state of the combat from the
     *         AI's perspective.
     */
     ...
     *
     * @return a new CombatState with copied teams and inventories, and the same
     *         current indices.
     */
    CombatState copy() {
