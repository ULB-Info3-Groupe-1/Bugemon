...
public class Combat {
     ...
     *
     * <p>
     * The counter starts at {@code 0} and is incremented at the end of every non-forfeit turn.
     * </p>
     *
     ...
     * @param action
     *            the action to apply; no-op if it is an attack or forfeit.
     */
    ...
    /**
     * Resolves the attack phase of a turn given the (possibly absent) attacks of each side.
     *
     * <p>
     ...
     *
     * @param attacker
     *            the trainer dealing the damage; must not be {@code null}.
     * @param defender
