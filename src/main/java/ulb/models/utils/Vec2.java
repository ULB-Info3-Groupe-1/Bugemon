...
public class Vec2 {
    ...
    /**
     * Linearly interpolates between two vectors a and b by a factor of t (0 <= t <= 1). When t=0, returns a; when t=1,
     * returns b; when t=0.5, returns the midpoint between a and b.
     *
     * @param a
     *            (Vec2) the starting vector
     * @param b
     *            (Vec2) the ending vector
     * @param t
     *            (float) the interpolation factor, typically between 0 and 1
