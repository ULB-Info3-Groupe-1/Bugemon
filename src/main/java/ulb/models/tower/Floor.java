...
/**
 * One level of the tower dungeon. Holds a tree of {@link FloorNode}s generated by
 * {@link ulb.models.tower.utils.FloorGenerator}; the player navigates the tree one node at a time via
 * {@link #moveTo(FloorNode)}.
 */
public class Floor {
    ...
    /**
     * Moves the player to {@code node} if it is adjacent to the current position (child or parent). Silently ignored if
     * {@code node} is not adjacent.
     */
