    ...
    static {
        strongAgainst = Map.of(ElementType.FLORA,
                Map.of(ElementType.FLORA, Efficiency.NEUTRAL, ElementType.AQUA, Efficiency.HIGH, ElementType.PYRO,
                        Efficiency.NEUTRAL, ElementType.LITHO, Efficiency.LOW),

                ElementType.AQUA,
                Map.of(ElementType.FLORA, Efficiency.LOW, ElementType.AQUA, Efficiency.NEUTRAL, ElementType.PYRO,
                        Efficiency.HIGH, ElementType.LITHO, Efficiency.NEUTRAL),

                ElementType.PYRO,
                Map.of(ElementType.FLORA, Efficiency.NEUTRAL, ElementType.AQUA, Efficiency.LOW, ElementType.PYRO,
                        Efficiency.NEUTRAL, ElementType.LITHO, Efficiency.HIGH),

                ElementType.LITHO, Map.of(ElementType.FLORA, Efficiency.HIGH, ElementType.AQUA, Efficiency.NEUTRAL,
                        ElementType.PYRO, Efficiency.LOW, ElementType.LITHO, Efficiency.NEUTRAL));
    }
}
