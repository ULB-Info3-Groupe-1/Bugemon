...
public class Attack {
     ...
     */
    public Attack(String id, String name, Bugemon.Type type, String description, int power, List<Effect> effects) {
        this.id = id;
        this.name = name;
        this.type = type;
     ...
     */
    public void setType(Bugemon.Type type) {
        this.type = type;
    }
