 ...
 * {@link ulb.models.bugemon_team.BugemonTeam} that does not contain a member
 ...
 * operating on a Bugemon that may not be present in the team is a realistic
 * possibility.
 * </p>
 *
...
public class BugemonNotInTeamException extends RuntimeException {
    /**
     * Constructs a new {@code BugemonNotInTeamException} with the specified
     * detail message.
     *
     * @param message a human-readable description of the violation; typically
     *                includes the ID of the Bugemon that was not found in the
     *                team.
     */
