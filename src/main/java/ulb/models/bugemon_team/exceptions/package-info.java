 ...
 *       — thrown by
 *       {@link ulb.models.bugemon_team.BugemonTeam#addBugemon(ulb.models.bugemon.Bugemon)}
 *       when the team has already reached its maximum capacity of six members
 *       and no further Bugemon can be added.</li>
 *   <li>{@link ulb.models.bugemon_team.exceptions.TeamAlreadyEmptyException}
 *       — thrown by
 *       {@link ulb.models.bugemon_team.BugemonTeam#removeBugemon(String)}
 *       when an attempt is made to remove a Bugemon from a team that contains
 *       no members.</li>
 *   <li>{@link ulb.models.bugemon_team.exceptions.BugemonNotInTeamException}
 *       — thrown by
 *       {@link ulb.models.bugemon_team.BugemonTeam#removeBugemon(String)}
 *       when no Bugemon with the requested ID exists in the team.</li>
 * </ul>
 *
