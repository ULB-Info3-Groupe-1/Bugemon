...
public class ManualTrainer extends Trainer {
     ...
     *             if no action has been queued yet.
     */
    @Override
    ...
    /**
     * Reacts to the active Bugemon fainting by switching to the target previously registered via
     * {@link #registerSwitchAfterKO(Bugemon)}.
     *
     * <p>
     ...
     *
     * @param action
     *            the {@link TurnAction} to queue; must not be {@code null}.
     */
     ...
     *
     * @param attack
     *            the {@link Attack} to use; must be in the active Bugemon's attack list.
     * @throws IllegalArgumentException
     *             if {@code attack} is not in the active Bugemon's move-set.
     */
     ...
     *
     * @param target
     *            the {@link Bugemon} to switch in; must be alive.
     * @throws IllegalArgumentException
     *             if {@code target} is not alive.
     */
     ...
     *
     * @param target
     *            the {@link Bugemon} to switch in on KO; must not be {@code null}.
     */
