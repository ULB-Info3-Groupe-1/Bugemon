...
public class AttackActionMenu extends ActionMenuView {
    ...
    public void setAttacks(Attack attack1, Attack attack2, Attack attack3) {
        ...
        this.action1.setText(attack1.getName() + "\n" +
            this.controller.isAttackEfficient(attack1.getType(), this.controller.getOpponentBugemonType()).toString()
    );
        ...
        this.action2.setText(attack2.getName() + "\n" +
            this.controller.isAttackEfficient(attack2.getType(), this.controller.getOpponentBugemonType()).toString()
    );
        ...
        this.action3.setText(attack3.getName() + "\n" +
            this.controller.isAttackEfficient(attack3.getType(), this.controller.getOpponentBugemonType()).toString()
    );
