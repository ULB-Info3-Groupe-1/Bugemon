...
public class Main extends Application {
        ...
        public void start(Stage stage) throws Exception {
                ...
                TeamService teamService = new TeamService(playerRepository, teamRepository, bugemonRepository,
                                playerName,
                                skillService);
                InventoryService inventoryService = new InventoryService(playerRepository, inventoryRepository,
                                playerName,
                                skillService);
