...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        bugemonRepository.addAllPlayerBugemons(playerName); // TODO: remove this method
        ...
        PlayerState playerState = new PlayerState(playerName, teamService.getActiveTeam().orElse(null),
                inventoryService.loadInventory(), playerService.getUnlockedSkills());
