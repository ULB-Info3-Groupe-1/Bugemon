 ...
 * level-up screen for a {@link ulb.models.bugemon.Bugemon} that has accumulated
 * enough XP to advance to the next level.
 *
 * <p>
...
public interface LevelUpDTO {
    /**
     * Returns a {@link BugemonDTO} view of the {@link ulb.models.bugemon.Bugemon}
     * that triggered this level-up event.
     *
     * @return the levelling-up Bugemon as a {@link BugemonDTO}; never
     *         {@code null}.
     */
     ...
     *
     * <p>
     * Typically contains exactly three choices, each with randomly distributed
