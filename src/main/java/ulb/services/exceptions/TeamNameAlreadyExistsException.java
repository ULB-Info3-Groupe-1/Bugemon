...
/**
 * Unchecked exception thrown when an attempt is made to save a team with a name
 ...
 * raises this exception rather than silently overwriting an existing team or creating
 * a duplicate entry.
 * </p>
 *
 * <p>
 ...
 * duplicate team names are a realistic possibility (e.g., when users are creating
 * or renaming teams).
 * </p>
 *
 * <p>Example usage:</p>
...
public class TeamNameAlreadyExistsException extends Exception {
    /**
     * Constructs a new {@code TeamNameAlreadyExistsException} with the specified
     * detail message.
     *
     * @param message a human-readable description of the duplication conflict;
     *                typically includes the team name that already exists.
     */
