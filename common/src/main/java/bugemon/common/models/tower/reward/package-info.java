 ...
 * <li>{@link bugemon.common.models.tower.reward.BonusStatsReward} — applies a permanent stat bonus to a team
 * member.</li>
 * <li>{@link bugemon.common.models.tower.reward.ItemReward} — adds a quantity of a consumable item to the player's
 * inventory.</li>
 * </ul>
 *
 * <p>
 * The marker interface {@link bugemon.common.models.tower.reward.Reward} is the common type used by controllers.
 * {@link bugemon.common.models.tower.reward.RewardGenerator} builds the triplet for a given floor, biasing attack
 * rewards toward types compatible with the current team.
 */
