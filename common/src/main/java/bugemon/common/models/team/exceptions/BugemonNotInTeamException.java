...
/**
 * Thrown when attempting to access or remove a {@link bugemon.common.models.player.PlayerBugemon} that is not currently a member
 * of the target {@link bugemon.common.models.team.Team}.
 */
