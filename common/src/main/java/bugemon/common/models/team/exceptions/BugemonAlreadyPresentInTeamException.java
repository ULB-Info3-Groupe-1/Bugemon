...
/**
 * Thrown when attempting to add a {@link bugemon.common.models.player.PlayerBugemon} that is already a member of the target
 * {@link bugemon.common.models.team.Team} (membership is determined by name equality).
 */
