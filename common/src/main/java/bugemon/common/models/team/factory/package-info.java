 ...
 *
 * <p>
 * The abstract base class {@link bugemon.common.models.team.factory.TeamFactory} declares the {@code create(int, List)}
 * factory method. Two concrete implementations are provided:
 *
 * <ul>
 * <li>{@link bugemon.common.models.team.factory.BossTeamFactory} — always places the designated boss Bugémon first,
 * then fills remaining slots randomly.</li>
